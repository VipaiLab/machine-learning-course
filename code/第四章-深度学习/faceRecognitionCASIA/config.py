...
class Config:
    ...
    train_root = 'D:/PycharmProjects/Assignment03_FaceVerification/datasets/tinyCASIA'
    test_root = 'D:/PycharmProjects/Assignment03_FaceVerification/datasets/data'
    test_list = "/data/lfw_test_pair.txt"
